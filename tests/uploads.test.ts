import fs from 'fs';
import type { ResponseLike } from 'emcees-20260311/internal/to-file';
import { toFile } from 'emcees-20260311/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('emcees-20260311/core/uploads');
    await expect(
